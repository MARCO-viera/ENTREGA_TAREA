...
<title>Resolviendo Tareas</title>
</head>
<body>
...
<h1  >Registrar Medicamento</h1>
	...
	<form id="id_form"> 
		<div class="row" style="margin-top: 5%">
			...
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
					<label class="control-label" for="id_dni">Precio</label>
				</div>
				<div class="col-sm-6">
			...
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
					<label class="control-label" for="id_dni">Stock</label>
				</div>
				<div class="col-sm-8">
			...
			<div class="form-group col-sm-6">
				<div class="col-sm-4">
					<label class="control-label" for="id_nombre">Laboratorio</label>
				</div>
				<div class="col-sm-8">
					<input class="form-control" type="text" id="id_laboratorio" name="laboratorio" placeholder="Ingrese el laboratorio" maxlength="20">
				</div>
			</div>
